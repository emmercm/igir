...
!!! danger
    ...
    Emulators are generally _legal_, as long as they don't include copyrighted software such as a console BIOS. Downloading ROM files that you do not own is piracy which is _illegal_ in most countries.
...
| Dumpable with special hardware | [Open Source Cartridge Reader](https://github.com/sanni/cartreader)<br/>([Save the Hero Builders](https://savethehero.builders/)) | [INLretro Dumper](https://web.archive.org/web/20260521140332/https://www.infiniteneslives.com/inlretro.php) | [Retrode2](https://www.retrode.com/en/welcome/) | [Retrode3](https://www.retrode.com/en/) | Other hardware                                                                                                                                                    |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|-------------------------------------------------|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Atari - Lynx                   | ✅ (V3 w/ adapter)                                                                                                                 | ❌                                                                                                           | ❌                                               | ❌                                       | [BennVenn JoeyLynx](https://bennvenn.myshopify.com/products/joeylynx-cart-flasher)                                                                                |
| Nintendo - GB, GBC, GBA        | ✅                                                                                                                                 | ✅                                                                                                           | ✅ (w/ adapter)                                  | ❌                                       | [Epilogue GB Operator](https://www.epilogue.co/product/gb-operator), [BennVenn Joey Jr](https://bennvenn.myshopify.com/products/usb-gb-c-cart-dumper-the-joey-jr) |
| Nintendo - NES/Famicom         | ✅ (V3 w/ adapter)                                                                                                                 | ✅                                                                                                           | ❌                                               | ✅                                       |                                                                                                                                                                   |
| Nintendo - Nintendo 64         | ✅ including controller pak saves (V3 w/ addon for EEPROM saves)                                                                   | ✅                                                                                                           | ✅ including controller park saves (w/ adapter)  | ❌                                       | [BennVenn JoeyN64](https://bennvenn.myshopify.com/products/joeyn64-cart-flasher)                                                                                  |
| Nintendo - SNES/SFC            | ✅ (V3 w/ addon for some)                                                                                                          | ✅                                                                                                           | ✅                                               | ✅                                       | [Epilogue SN Operator](https://www.epilogue.co/product/sn-operator)                                                                                               |
| Sega - Game Gear               | ✅ (w/ Retrode Master System adapter)                                                                                              | ❌                                                                                                           | ✅ (w/ Master System adapter)                    | ❌                                       | [BennVenn JoeyGG](https://bennvenn.myshopify.com/products/joeygg-cart-flasher)                                                                                    |
| Sega - Genesis/MD              | ✅                                                                                                                                 | ✅                                                                                                           | ✅                                               | ✅                                       |                                                                                                                                                                   |
| Sega - Master System           | ✅ (V3 w/ adapter)                                                                                                                 | ❌                                                                                                           | ✅ (w/ adapter)                                  | ❌                                       | [BennVenn JoeySMS](https://bennvenn.myshopify.com/products/joeysms-cart-flasher)                                                                                  |
...
| Sony - PSP              | [UMD Image Creator](https://github.com/saramibreak/UmdImageCreator), [PSP Filer](https://wiki.redump.info/Sony_PlayStation_Portable_Dumping_Guide)                                                                              |                                              |
