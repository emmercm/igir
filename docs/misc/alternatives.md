...
| Feature                                    | [igir](../index.md)                                                                                                       | [RomVault](https://www.romvault.com/)                                      | [clrmame](https://mamedev.emulab.it/clrmamepro/)                            | [RomCenter](http://www.romcenter.com/)     |
|--------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------|--------------------------------------------|
...
| App: install via package managers          | ✅ [multiple options](../installation.md)                                                                                  | ❌                                                                          | ❌                                                                           | ❌                                          |
| App: auto-updating                         | ⚠️ depends on the [installation](../installation.md) method                                                               | ✅                                                                          | ❓                                                                           | ❓                                          |
...
| DATs: built-in download manager            | ❌                                                                                                                         | ⚠️ via [DatVault](https://www.datvault.com/) (semi-paid)                   | ❌                                                                           | ❌                                          |
...
| ROMs: trimming detection & matching        | ✅ [trimming docs](../roms/trim-detection.md)                                                                              | ❌                                                                          | ❌                                                                           | ❌                                          |
...
| Archives: `.chd` support                   | ⚠️ via [`chdman`](https://docs.mamedev.org/tools/chdman.html) (bundled<sup>1</sup>)                                       | ✅ v1-5 natively                                                            | ⚠️ via [`chdman`](https://docs.mamedev.org/tools/chdman.html) (not bundled) | ⚠️ v1-4 natively                           |
| Archives: `.cso` & `.zso` support          | ⚠️ via [`maxcso`](https://github.com/unknownbrackets/maxcso) (bundled<sup>1</sup>)                                        | ❌                                                                          | ❌                                                                           | ❌                                          |
| Archives: `.gcz`, `.rvz`, & `.wia` support | ⚠️ via [`dolphin-tool`](https://github.com/dolphin-emu/dolphin/tree/master/Source/Core/DolphinTool) (bundled<sup>1</sup>) | ❌                                                                          | ❌                                                                           | ❌                                          |
...
<small>
<sup>1</sup> Igir will prefer binaries on your `$PATH`/`%PATH%` over bundled binaries, allowing you to update them independently.
</small>
