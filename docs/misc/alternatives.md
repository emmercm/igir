...
| Archives: `.chd` support                   | ✅ v1-5 natively                                                                                                           | ⚠️ v1-5 natively, but quick scan only                                      | ⚠️ via [`chdman`](https://docs.mamedev.org/tools/chdman.html) (not bundled) | ⚠️ v1-4 natively                           |
