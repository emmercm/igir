...
RetroDECK is a self contained application package that uses [EmulationStation](https://emulationstation.org/) as a frontend for [RetroArch](retroarch.md) and many other standalone emulators. It is primarily designed and optimised for the Steam Deck.
