...
describe('dirLetterGroup', () => {
  test.each([
    ...
    [
      ...
      [
        // A and B get grouped
        path.resolve('Output', 'A-B', 'Admirable.rom'),
        path.resolve('Output', 'A-B', 'Adorable.rom'),
        path.resolve('Output', 'A-B', 'Adventurous.rom'),
        path.resolve('Output', 'A-B', 'Amazing.rom'),
        path.resolve('Output', 'A-B', 'Awesome.rom'),
        path.resolve('Output', 'A-B', 'Best.rom'),
        path.resolve('Output', 'A-B', 'Brilliant.rom'),
        path.resolve('Output', 'D', 'Dainty', 'Dainty (Track 01).bin'),
        path.resolve('Output', 'D', 'Dainty', 'Dainty.cue'),
        path.resolve('Output', 'D', 'Daring', 'Daring (Track 01).bin'),
        path.resolve('Output', 'D', 'Daring', 'Daring.cue'),
    ...
    [
      ...
      3,
      [
        path.resolve('Output', 'AD', 'Admirable.rom'),
        path.resolve('Output', 'AD', 'Adorable.rom'),
        path.resolve('Output', 'AD', 'Adventurous.rom'),
        path.resolve('Output', 'AM-BE', 'Amazing.rom'),
        path.resolve('Output', 'AM-BE', 'Awesome.rom'),
        path.resolve('Output', 'AM-BE', 'Best.rom'),
        path.resolve('Output', 'BR', 'Brilliant.rom'),
        path.resolve('Output', 'DA', 'Dainty', 'Dainty (Track 01).bin'),
        path.resolve('Output', 'DA', 'Dainty', 'Dainty.cue'),
        path.resolve('Output', 'DA', 'Daring', 'Daring (Track 01).bin'),
        path.resolve('Output', 'DA', 'Daring', 'Daring.cue'),
        path.resolve('Output', 'DA', 'Dazzling', 'Dazzling (Track 01).bin'),
        path.resolve('Output', 'DA', 'Dazzling', 'Dazzling.cue'),
        path.resolve('Output', 'DE-DI', 'Dedicated', 'Dedicated (Track 01).bin'),
        path.resolve('Output', 'DE-DI', 'Dedicated', 'Dedicated.cue'),
        path.resolve('Output', 'DE-DI', 'disk1', 'Cheerful.rom'),
        path.resolve('Output', 'DE-DI', 'disk1', 'Confident.rom'),
        path.resolve('Output', 'DE-DI', 'disk1', 'Cool.rom'),
      ],
    ],
    [
      3,
