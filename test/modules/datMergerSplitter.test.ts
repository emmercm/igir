...
describe('MAME v0.258', () => {
  ...
  const dat = new LogiqxDAT(new Header(), [
    ...
    new Machine({
      ...
      rom: [
        new ROM({ name: '901227-01.u4', bios: 'r1', size: 8192, crc: 'dce782fa', sha1: '87cc04d61fc748b82df09856847bb5c2754a2033' }),
        new ROM({ name: '901227-02.u4', bios: 'r2', size: 8192, crc: 'a5c687b3', sha1: '0e2e4ee3f2d41f00bed72f9ab588b83e306fdb13' }),
        new ROM({ name: '901227-03.u4', bios: 'r3', size: 8192, crc: 'dbe3e7c7', sha1: '1d503e56df85a62fee696e7618dc5b4e781df1bb' }),
        new ROM({ name: 'jiffydos c64.u4', bios: 'jiffydos', size: 8192, crc: '2f79984c', sha1: '31e73e66eccb28732daea8ec3ad1addd9b39a017' }),
        new ROM({ name: 'speed-dos.u4', bios: 'speeddos', size: 8192, crc: '5beb9ac8', sha1: '8896c8de9e26ef1396eb46020b2de346a3eeab7e' }),
        new ROM({ name: 'speed-dosplus.u4', bios: 'speeddos20', size: 8192, crc: '10aee0ae', sha1: '6cebd4dc0c5e8c0b073586a3f1c43cc3349b9736' }),
        new ROM({ name: 'speed-dosplus27.u4', bios: 'speeddos27', size: 8192, crc: 'ff59995e', sha1: 'c8d864e5fc7089af8afce97dc0a0224df11df1c3' }),
        new ROM({ name: 'prodos.u4', bios: 'prodos', size: 8192, crc: '37ed83a2', sha1: '35f4f0fe03c0b7b3762b526ba855de41b496fb60' }),
        new ROM({ name: 'prodos24l2.u4', bios: 'prodos2', size: 8192, crc: '41dad9fe', sha1: 'fbf3dcc2ed40e58b07595740ea6fbff7ab19ebad' }),
        new ROM({ name: 'prodos35l2.u4', bios: 'prodos3', size: 8192, crc: '2822eee7', sha1: '77356b84c1648018863d1c8dd5bc3a37485bc00e' }),
        new ROM({ name: 'turborom.u4', bios: 'turborom', size: 8192, crc: 'e6c763a2', sha1: 'eff5a4b6bc65daa9421bd3856dd99a3195068e1c' }),
        new ROM({ name: 'dosrom12.u4', bios: 'dosrom', size: 8192, crc: 'ac030fc0', sha1: '0e4b38e81b49f55d52162154a44f0fffd2b0d04f' }),
        new ROM({ name: 'turborom2.u4', bios: 'turborom2', size: 8192, crc: 'ea3ba683', sha1: '4bb23f764a3d255119fbae37202ca820caa04e1f' }),
        new ROM({ name: 'mercury3.u4', bios: 'mercury', size: 8192, crc: '6eac46a2', sha1: '4e351aa5fcb97c4c21e565aa2c830cc09bd47533' }),
        new ROM({ name: 'kernal-10-mager.u4', bios: 'dolphin', size: 8192, crc: 'c9bb21bc', sha1: 'e305216e50ff8a7acf102be6c6343e3d44a16233' }),
        new ROM({ name: 'kernal-20-1_au.u4', bios: 'dolphin201au', size: 8192, crc: '7068bbcc', sha1: '325ce7e32609a8fc704aaa76f5eb4cd7d8099a92' }),
        new ROM({ name: 'kernal-20-1.u4', bios: 'dolphin201', size: 8192, crc: 'c9c4c44e', sha1: '7f5d8f08c5ed2182ffb415a3d777fdd922496d02' }),
        new ROM({ name: 'kernal-20-2.u4', bios: 'dolphin202', size: 8192, crc: 'ffaeb9bc', sha1: '5f6c1bad379da16f77bccb58e80910f307dfd5f8' }),
        new ROM({ name: 'kernal-20-3.u4', bios: 'dolphin203', size: 8192, crc: '4fd511f2', sha1: '316fba280dcb29496d593c0c4e3ee9a19844054e' }),
        new ROM({ name: 'kernal-30.u4', bios: 'dolphin30', size: 8192, crc: '5402d643', sha1: '733acb96fead2fb4df77840c5bb618f08439fc7e' }),
        new ROM({ name: 'turboaccess26.u4', bios: 'taccess', size: 8192, crc: '93de6cd9', sha1: 'a74478f3b9153c13176eac80ebfacc512ae7cbf0' }),
        new ROM({ name: 'turboaccess301.u4', bios: 'ttrans301', size: 8192, crc: 'b3304dcf', sha1: '4d47a265ef65e4823f862cfc3d514c2a71473580' }),
        new ROM({ name: 'turboaccess302.u4', bios: 'ttrans302', size: 8192, crc: '9e696a7b', sha1: '5afae75d66d539f4bb4af763f029f0ef6523a4eb' }),
        new ROM({ name: 'turboprocess.u4', bios: 'tprocess', size: 8192, crc: 'e5610d76', sha1: 'e3f35777cfd16cce4717858f77ff354763395ba9' }),
        new ROM({ name: 'turboprocessus.u4', bios: 'tprocessn', size: 8192, crc: '7480b76a', sha1: 'ef1664b5057ae3cc6d104fc2f5c1fb29ee5a1b2b' }),
        new ROM({ name: 'exos3.u4', bios: 'exos3', size: 8192, crc: '4e54d020', sha1: 'f8931b7c0b26807f4de0cc241f0b1e2c8f5271e9' }),
        new ROM({ name: 'exos4.u4', bios: 'exos4', size: 8192, crc: 'd5cf83a9', sha1: 'd5f03a5c0e9d00032d4751ecc6bcd6385879c9c7' }),
        new ROM({ name: 'digidos.u4', bios: 'digidos', size: 8192, crc: '2b0c8e89', sha1: '542d6f61c318bced0642e7c2d4d3b34a0f13e634' }),
        new ROM({ name: 'magnum.u4', bios: 'magnum', size: 8192, crc: 'b2cffcc6', sha1: '827c782c1723b5d0992c05c00738ae4b2133b641' }),
        new ROM({ name: 'mercury31s.u4', bios: 'mercury31s', size: 8192, crc: '97aa5d2f', sha1: '9fc653e61c34225245036f266db14e05feeadb21' }),
        new ROM({ name: '901226-01.u3', size: 8192, crc: 'f833d117', sha1: '79015323128650c742a3694c9429aa91f355905e' }),
        new ROM({ name: '901225-01.u5', size: 4096, crc: 'ec4272ee', sha1: 'adc7c31e18c7c7413d54802ef2f4193da14711aa' }),
        new ROM({ name: '906114-01.u17', size: 245, crc: '54c89351', sha1: 'efb315f560b6f72444b8f0b2ca4b0ccbcd144a1b' }),
      ],
      deviceRef: [
        new DeviceRef('m6510'),
    ...
    new Machine({
      ...
      rom: [
        new ROM({ name: '901229-01.uab5', bios: 'r1', size: 8192, crc: '9a48d3f0', sha1: '7a1054c6156b51c25410caec0f609efb079d3a77' }),
        new ROM({ name: '901229-02.uab5', bios: 'r2', size: 8192, crc: 'b29bab75', sha1: '91321142e226168b1139c30c83896933f317d000' }),
        new ROM({ name: '901229-03.uab5', bios: 'r3', size: 8192, crc: '9126e74a', sha1: '03d17bd745066f1ead801c5183ac1d3af7809744' }),
        new ROM({ name: '901229-04.uab5', bios: 'r4', size: 8192, status: 'nodump' }),
        new ROM({ name: '901229-05 ae.uab5', bios: 'r5', size: 8192, crc: '361c9f37', sha1: 'f5d60777440829e46dc91285e662ba072acd2d8b' }),
        new ROM({ name: '901229-06 aa.uab5', bios: 'r6', size: 8192, crc: '3a235039', sha1: 'c7f94f4f51d6de4cdc21ecbb7e57bb209f0530c0' }),
        new ROM({ name: 'jiffydos 1541.uab5', bios: 'jiffydos', size: 8192, crc: 'bc7e4aeb', sha1: 'db6cfaa6d9b78d58746c811de29f3b1f44d99ddf' }),
        new ROM({ name: 'speed-dosplus.uab5', bios: 'speeddos', size: 16384, crc: 'f9db1eac', sha1: '95407e59a9c1d26a0e4bcf2c244cfe8942576e2c' }),
        new ROM({ name: 'rolo27.uab5', bios: 'rolo27', size: 8192, crc: '171c7962', sha1: '04c892c4b3d7c74750576521fa081f07d8ca8557' }),
        new ROM({ name: 'ttd34.uab5', bios: 'tt34', size: 32768, crc: '518d34a1', sha1: '4d6ffdce6ab122e9627b0a839861687bcd4e03ec' }),
        new ROM({ name: 'digidos.uab5', bios: 'digidos', size: 8192, crc: 'b3f05ea3', sha1: '99d3d848344c68410b686cda812f3788b41fead3' }),
        new ROM({ name: '325302-01.uab4', size: 8192, crc: '29ae9752', sha1: '8e0547430135ba462525c224e76356bd3d430f11' }),
      ],
      deviceRef: [
        new DeviceRef('m6502'),
        new DeviceRef('mos6522'),
  ...
  const dat = new LogiqxDAT(new Header(), [
    new Game({
      ...
      rom: [
        ...
        new ROM({ name: '043-c1.c1', size: 2097152, crc: 'bad2d67f' }),
        new ROM({ name: '043-c2.c2', size: 2097152, crc: 'a7fbda95' }),
        new ROM({ name: '043-c3.c3', size: 2097152, crc: 'f00be011' }),
        new ROM({ name: '043-c4.c4', size: 2097152, crc: '1887e5c0' }),
        new ROM({ name: '043-m1.m1', size: 131072, crc: '7eab59cb' }),
        new ROM({ name: '043-v1.v1', size: 2097152, crc: '63688ce8' }),
        new ROM({ name: '043-v2.v2', size: 2097152, crc: 'c69a827b' }),
        new ROM({ name: 'sp-s3.sp1', merge: 'sp-s3.sp1', size: 131072, crc: '91b64be3' }),
        new ROM({ name: 'sp-s2.sp1', merge: 'sp-s2.sp1', size: 131072, crc: '9036d879' }),
        new ROM({ name: 'sp-s.sp1', merge: 'sp-s.sp1', size: 131072, crc: 'c7f2fa45' }),
        new ROM({ name: 'sp-u2.sp1', merge: 'sp-u2.sp1', size: 131072, crc: 'e72943de' }),
        new ROM({ name: 'sp1-u2', merge: 'sp1-u2', size: 131072, crc: '62f021f4' }),
        new ROM({ name: 'sp-e.sp1', merge: 'sp-e.sp1', size: 131072, crc: '2723a5b5' }),
        new ROM({ name: 'sp1-u4.bin', merge: 'sp1-u4.bin', size: 131072, crc: '1179a30f' }),
        new ROM({ name: 'sp1-u3.bin', merge: 'sp1-u3.bin', size: 131072, crc: '2025b7a2' }),
        new ROM({ name: 'vs-bios.rom', merge: 'vs-bios.rom', size: 131072, crc: 'f0e8f27d' }),
        new ROM({ name: 'sp-j2.sp1', merge: 'sp-j2.sp1', size: 131072, crc: 'acede59c' }),
        new ROM({ name: 'sp1.jipan.1024', merge: 'sp1.jipan.1024', size: 131072, crc: '9fb0abe4' }),
        new ROM({ name: 'sp-45.sp1', merge: 'sp-45.sp1', size: 524288, crc: '03cc9f6a' }),
        new ROM({ name: 'sp-j3.sp1', merge: 'sp-j3.sp1', size: 524288, crc: '486cb450' }),
        new ROM({ name: 'japan-j3.bin', merge: 'japan-j3.bin', size: 131072, crc: 'dff6d41f' }),
        new ROM({ name: 'sp1-j3.bin', merge: 'sp1-j3.bin', size: 131072, crc: 'fbc6d469' }),
        new ROM({ name: 'neo-po.bin', merge: 'neo-po.bin', size: 131072, crc: '16d0c132' }),
        new ROM({ name: 'neo-epo.bin', merge: 'neo-epo.bin', size: 131072, crc: 'd27a71f1' }),
        new ROM({ name: 'neodebug.bin', merge: 'neodebug.bin', size: 131072, crc: '698ebb7d' }),
        new ROM({ name: 'sp-1v1_3db8c.bin', merge: 'sp-1v1_3db8c.bin', size: 131072, crc: '162f0ebe' }),
        new ROM({ name: 'uni-bios_4_0.rom', merge: 'uni-bios_4_0.rom', size: 131072, crc: 'a7aab458' }),
        new ROM({ name: 'uni-bios_3_3.rom', merge: 'uni-bios_3_3.rom', size: 131072, crc: '24858466' }),
        new ROM({ name: 'uni-bios_3_2.rom', merge: 'uni-bios_3_2.rom', size: 131072, crc: 'a4e8b9b3' }),
        new ROM({ name: 'uni-bios_3_1.rom', merge: 'uni-bios_3_1.rom', size: 131072, crc: '0c58093f' }),
        new ROM({ name: 'uni-bios_3_0.rom', merge: 'uni-bios_3_0.rom', size: 131072, crc: 'a97c89a9' }),
        new ROM({ name: 'uni-bios_2_3.rom', merge: 'uni-bios_2_3.rom', size: 131072, crc: '27664eb5' }),
        new ROM({ name: 'uni-bios_2_3o.rom', merge: 'uni-bios_2_3o.rom', size: 131072, crc: '601720ae' }),
        new ROM({ name: 'uni-bios_2_2.rom', merge: 'uni-bios_2_2.rom', size: 131072, crc: '2d50996a' }),
        new ROM({ name: 'uni-bios_2_1.rom', merge: 'uni-bios_2_1.rom', size: 131072, crc: '8dabf76b' }),
        new ROM({ name: 'uni-bios_2_0.rom', merge: 'uni-bios_2_0.rom', size: 131072, crc: '0c12c2ad' }),
        new ROM({ name: 'uni-bios_1_3.rom', merge: 'uni-bios_1_3.rom', size: 131072, crc: 'b24b44a0' }),
        new ROM({ name: 'uni-bios_1_2.rom', merge: 'uni-bios_1_2.rom', size: 131072, crc: '4fa698e9' }),
        new ROM({ name: 'uni-bios_1_2o.rom', merge: 'uni-bios_1_2o.rom', size: 131072, crc: 'e19d3ce9' }),
        new ROM({ name: 'uni-bios_1_1.rom', merge: 'uni-bios_1_1.rom', size: 131072, crc: '5dda0d84' }),
        new ROM({ name: 'uni-bios_1_0.rom', merge: 'uni-bios_1_0.rom', size: 131072, crc: '0ce453a0' }),
        new ROM({ name: 'neopen.sp1', merge: 'neopen.sp1', size: 131072, crc: 'cb915e76' }),
        new ROM({ name: 'sm1.sm1', merge: 'sm1.sm1', size: 131072, crc: '94416d67' }),
        new ROM({ name: 'sfix.sfix', merge: 'sfix.sfix', size: 131072, crc: 'c2ea0cfd' }),
        new ROM({ name: '000-lo.lo', merge: '000-lo.lo', size: 131072, crc: '5a86cff2' }),
      ],
    }),
    new Game({
      name: '3countba',
      ...
      rom: [
        ...
        new ROM({ name: '043-s1.s1', merge: '043-s1.s1', size: 131072, crc: 'c362d484' }),
        new ROM({ name: '043-c1.c1', merge: '043-c1.c1', size: 2097152, crc: 'bad2d67f' }),
        new ROM({ name: '043-c2.c2', merge: '043-c2.c2', size: 2097152, crc: 'a7fbda95' }),
        new ROM({ name: '043-c3.c3', merge: '043-c3.c3', size: 2097152, crc: 'f00be011' }),
        new ROM({ name: '043-c4.c4', merge: '043-c4.c4', size: 2097152, crc: '1887e5c0' }),
        new ROM({ name: '043-m1.m1', merge: '043-m1.m1', size: 131072, crc: '7eab59cb' }),
        new ROM({ name: '043-v1.v1', merge: '043-v1.v1', size: 2097152, crc: '63688ce8' }),
        new ROM({ name: '043-v2.v2', merge: '043-v2.v2', size: 2097152, crc: 'c69a827b' }),
        new ROM({ name: 'sp-s3.sp1', merge: 'sp-s3.sp1', size: 131072, crc: '91b64be3' }),
        new ROM({ name: 'sp-s2.sp1', merge: 'sp-s2.sp1', size: 131072, crc: '9036d879' }),
        new ROM({ name: 'sp-s.sp1', merge: 'sp-s.sp1', size: 131072, crc: 'c7f2fa45' }),
        new ROM({ name: 'sp-u2.sp1', merge: 'sp-u2.sp1', size: 131072, crc: 'e72943de' }),
    ...
    new Game({
      ...
      rom: [
        ...
        new ROM({ name: 'sp-s.sp1', size: 131072, crc: 'c7f2fa45' }),
        new ROM({ name: 'sp-u2.sp1', size: 131072, crc: 'e72943de' }),
        new ROM({ name: 'sp1-u2', size: 131072, crc: '62f021f4' }),
        new ROM({ name: 'sp-e.sp1', size: 131072, crc: '2723a5b5' }),
        new ROM({ name: 'sp1-u4.bin', size: 131072, crc: '1179a30f' }),
        new ROM({ name: 'sp1-u3.bin', size: 131072, crc: '2025b7a2' }),
        new ROM({ name: 'vs-bios.rom', size: 131072, crc: 'f0e8f27d' }),
        new ROM({ name: 'sp-j2.sp1', size: 131072, crc: 'acede59c' }),
        new ROM({ name: 'sp1.jipan.1024', size: 131072, crc: '9fb0abe4' }),
        new ROM({ name: 'sp-45.sp1', size: 524288, crc: '03cc9f6a' }),
        new ROM({ name: 'sp-j3.sp1', size: 524288, crc: '486cb450' }),
        new ROM({ name: 'japan-j3.bin', size: 131072, crc: 'dff6d41f' }),
        new ROM({ name: 'sp1-j3.bin', size: 131072, crc: 'fbc6d469' }),
        new ROM({ name: 'neo-po.bin', size: 131072, crc: '16d0c132' }),
        new ROM({ name: 'neo-epo.bin', size: 131072, crc: 'd27a71f1' }),
        new ROM({ name: 'neodebug.bin', size: 131072, crc: '698ebb7d' }),
        new ROM({ name: 'sp-1v1_3db8c.bin', size: 131072, crc: '162f0ebe' }),
        new ROM({ name: 'uni-bios_4_0.rom', size: 131072, crc: 'a7aab458' }),
        new ROM({ name: 'uni-bios_3_3.rom', size: 131072, crc: '24858466' }),
        new ROM({ name: 'uni-bios_3_2.rom', size: 131072, crc: 'a4e8b9b3' }),
        new ROM({ name: 'uni-bios_3_1.rom', size: 131072, crc: '0c58093f' }),
        new ROM({ name: 'uni-bios_3_0.rom', size: 131072, crc: 'a97c89a9' }),
        new ROM({ name: 'uni-bios_2_3.rom', size: 131072, crc: '27664eb5' }),
        new ROM({ name: 'uni-bios_2_3o.rom', size: 131072, crc: '601720ae' }),
        new ROM({ name: 'uni-bios_2_2.rom', size: 131072, crc: '2d50996a' }),
        new ROM({ name: 'uni-bios_2_1.rom', size: 131072, crc: '8dabf76b' }),
        new ROM({ name: 'uni-bios_2_0.rom', size: 131072, crc: '0c12c2ad' }),
        new ROM({ name: 'uni-bios_1_3.rom', size: 131072, crc: 'b24b44a0' }),
        new ROM({ name: 'uni-bios_1_2.rom', size: 131072, crc: '4fa698e9' }),
        new ROM({ name: 'uni-bios_1_2o.rom', size: 131072, crc: 'e19d3ce9' }),
        new ROM({ name: 'uni-bios_1_1.rom', size: 131072, crc: '5dda0d84' }),
        new ROM({ name: 'uni-bios_1_0.rom', size: 131072, crc: '0ce453a0' }),
        new ROM({ name: 'neopen.sp1', size: 131072, crc: 'cb915e76' }),
        new ROM({ name: 'sm1.sm1', size: 131072, crc: '94416d67' }),
        new ROM({ name: 'sfix.sfix', size: 131072, crc: 'c2ea0cfd' }),
        new ROM({ name: '000-lo.lo', size: 131072, crc: '5a86cff2' }),
      ],
    }),
  ]);
