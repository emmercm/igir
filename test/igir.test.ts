...
describe('with inferred dats', () => {
  ...
  it('should copy and test', async () => {
    await expectEndToEnd({
      ...
      ['diagnostic_test_cartridge.7z|diagnostic_test_cartridge.a78', 'f6cc9b1c'],
      ['empty.rom', '00000000'],
      ['fds_joypad_test.zip|fds_joypad_test.fds', '1e58456d'],
      ['fizzbuzz.nes', '370517b5'],
      ['foobar.lnx', 'b22c9747'],
      ['KDULVQN.rom', 'b1c303e4'],
      ['LCDTestROM.rar|LCDTestROM.lnx', '2d251538'],
      ...
      ['speed_test_v51.gz|speed_test_v51.sfc', '8beffd94'],
