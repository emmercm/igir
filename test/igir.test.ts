  ...
  it('should copy a 1G1R set', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('One Three.zip')}|1/one.rom`, 'f817a89f'],
        [`${path.join('One Three.zip')}|2/two.rom`, '96170874'],
        [`${path.join('One Three.zip')}|3/three.rom`, 'ff46c5d8'],
  ...
  it('should copy and clean', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('zip', 'One', 'One Three.zip')}|1/one.rom`, 'f817a89f'],
        [`${path.join('zip', 'One', 'One Three.zip')}|2/two.rom`, '96170874'],
        [`${path.join('zip', 'One', 'One Three.zip')}|3/three.rom`, 'ff46c5d8'],
      ]);
      expect(result.cwdFilesAndCrcs).toHaveLength(0);
      expect(result.movedFiles).toHaveLength(0);
  ...
  it('should symlink and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('One', 'One Three.zip')}|1/one.rom -> ${path.join('<input>', 'zip', 'onetwothree.zip')}|${path.join('1', 'one.rom')}`, 'f817a89f'],
        [`${path.join('One', 'One Three.zip')}|2/two.rom -> ${path.join('<input>', 'zip', 'onetwothree.zip')}|${path.join('2', 'two.rom')}`, '96170874'],
        [`${path.join('One', 'One Three.zip')}|3/three.rom -> ${path.join('<input>', 'zip', 'onetwothree.zip')}|${path.join('3', 'three.rom')}`, 'ff46c5d8'],
  ...
  it('should relative symlink, and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`onetwothree.zip|1/one.rom -> ${path.join('..', 'input', 'roms', 'zip', 'onetwothree.zip')}|${path.join('1', 'one.rom')}`, 'f817a89f'],
        [`onetwothree.zip|2/two.rom -> ${path.join('..', 'input', 'roms', 'zip', 'onetwothree.zip')}|${path.join('2', 'two.rom')}`, '96170874'],
        [`onetwothree.zip|3/three.rom -> ${path.join('..', 'input', 'roms', 'zip', 'onetwothree.zip')}|${path.join('3', 'three.rom')}`, 'ff46c5d8'],
