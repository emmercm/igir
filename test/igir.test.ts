...
describe('with inferred dats', () => {
  ...
  it('should relative symlink, test, and clean', async () => {
    await expectEndToEnd({
      ...
      [`${path.join('fourfive', 'five.rom')} -> ${path.join('..', '..', 'input', 'roms', 'raw', 'five.rom')}`, '3e5daf67'],
      [`${path.join('fourfive', 'four.rom')} -> ${path.join('..', '..', 'input', 'roms', 'raw', 'four.rom')}`, '1cf3ca74'],
      ...
      [`${path.join('onetwothree', 'one.rom')} -> ${path.join('..', '..', 'input', 'roms', 'raw', 'one.rom')}`, 'f817a89f'],
      [`${path.join('onetwothree', 'three.rom')} -> ${path.join('..', '..', 'input', 'roms', 'raw', 'three.rom')}`, 'ff46c5d8'],
      [`${path.join('onetwothree', 'two.rom')} -> ${path.join('..', '..', 'input', 'roms', 'raw', 'two.rom')}`, '96170874'],
