...
- https://github.com/addnab/docker-run-action/issues/38 extremely naive newline replacement
- https://github.com/addnab/docker-run-action/issues/26 inability to use `$GITHUB_ENV`
